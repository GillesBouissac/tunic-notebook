...
import type { PointerType } from './pointer-tracker'; // separate type out to own line
...
export default class PinchZoom {
	...
	private _handle: HTMLElement | null | undefined = null;
	...
	private _onPointerMove(previousPointers: PointerType[], currentPointers: PointerType[]) {
		if (!this._parentEl) return;
